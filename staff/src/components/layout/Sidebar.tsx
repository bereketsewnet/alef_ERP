...
export function Sidebar({ className, collapsed, setCollapsed }: SidebarProps) {
    ...
    return (
        <div className={cn("relative flex flex-col h-screen border-r bg-white dark:bg-neutral-950 transition-all duration-300", collapsed ? "w-16" : "w-64", className)}>
                        ...
                        return (
                            <Link
                                ...
                                className={cn(
                                    ...
                                    isActive ? "bg-primary-50 text-primary-600 dark:bg-primary-900/20 dark:text-primary-400" : "text-neutral-500 dark:text-neutral-400",
