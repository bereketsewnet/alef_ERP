                                ...
                                <CardContent className="h-[320px]">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <RechartsBar data={assetData?.by_company || []} margin={{ top: 10, right: 10, left: 0, bottom: 55 }}>
                                            <CartesianGrid strokeDasharray="3 3" /><XAxis dataKey="name" angle={-35} textAnchor="end" interval={0} height={75} /><YAxis allowDecimals={false} /><Tooltip /><Bar dataKey="count" name="Assets" fill="#07324A" />
                                        </RechartsBar>
                                    </ResponsiveContainer>
                                </CardContent>
                            </Card>
